...
jQuery(document).ready(function(){
	...
	jQuery('.event-entry-ukulele-workshop-hum-and-strum-at-central-library .event_details_button a').text('Register');
	jQuery('.event-entry-ukulele-workshop-hum-and-strum-at-potomac-library .event_details_button a').text('Register');
	jQuery('.event-entry-eco-graphic-arts-workshops .event_details_button a').text('Register');
	jQuery('.event-entry-veterans-virtual-guitar-workshops-level-i .event_details_button a').text('Register');
	jQuery('.event-entry-veterans-virtual-guitar-workshops-level-ii .event_details_button a').text('Register');
